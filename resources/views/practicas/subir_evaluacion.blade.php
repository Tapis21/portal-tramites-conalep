...
<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
            <h2 class="text-2xl font-bold mb-5">Subir Evaluación de Competencias - Prácticas Profesionales</h2>
            ...
            <p class="mb-4 text-sm text-gray-600">Documento donde se evalúa el desempeño del estudiante durante sus Prácticas Profesionales.</p>
            ...
            <form method="POST" action="{{ route('practicas.guardar-evaluacion', $practica->id) }}" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea name="comentario" rows="2" class="w-full p-2 border rounded" placeholder="Ej: Evaluación realizada por..."></textarea>
