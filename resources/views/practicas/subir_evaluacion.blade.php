...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <!-- Título con icono - VERDE -->
    <div class="flex items-center gap-3 mb-6">
        <span class="iconify w-8 h-8 sm:w-10 sm:h-10 text-green-600" data-icon="mdi:file-check"></span>
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Subir Evaluación de Competencias - Prácticas Profesionales</h1>
    </div>
    ...
    <!-- ========================================== -->
    <form method="POST" action="{{ route('practicas.guardar-evaluacion', $practica->id) }}" enctype="multipart/form-data" 
        ...
        <div class="p-4 sm:p-8 space-y-6">
            ...
            <div class="bg-white/70 rounded-lg p-4 border border-[#d4c9b8]">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-700 font-medium">Documento donde se evalúa el desempeño del estudiante durante sus Prácticas Profesionales.</p>
            ...
            <div class="bg-white/80 rounded-lg p-4 border border-[#d4c9b8]">
                <label class="block text-gray-700 font-semibold text-sm mb-2">
                    ...
                    Archivo PDF (Evaluación) <span class="text-red-500">*</span>
                </label>
                <div class="relative">
            ...
            <div class="bg-white/80 rounded-lg p-4 border border-[#d4c9b8]">
                ...
                <textarea name="comentario" rows="3" 
                          ...
                          placeholder="Ej: Evaluación realizada por..."></textarea>
                <p class="text-xs text-gray-500 mt-1.5 flex items-center gap-1">
                    <span class="iconify w-3.5 h-3.5 text-gray-400" data-icon="mdi:information-outline"></span>
