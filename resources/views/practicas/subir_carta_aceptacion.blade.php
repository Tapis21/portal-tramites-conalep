...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <!-- Título con icono - CAFÉ/ÁMBAR -->
    <div class="flex items-center gap-3 mb-6">
        <span class="iconify w-8 h-8 sm:w-10 sm:h-10 text-amber-700" data-icon="mdi:file-sign"></span>
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Subir Carta de Aceptación - Prácticas Profesionales</h1>
    </div>
    ...
    <!-- ========================================== -->
    <form method="POST" action="{{ route('practicas.guardar-carta-aceptacion', $practica->id) }}" enctype="multipart/form-data" 
        ...
        <div class="p-4 sm:p-8 space-y-6">
            ...
            <div class="bg-white/70 rounded-lg p-4 border border-[#d4c9b8]">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-700 font-medium">Documento emitido por la empresa donde el estudiante realizará sus Prácticas Profesionales, confirmando su aceptación.</p>
            ...
            <div class="bg-white/80 rounded-lg p-4 border border-[#d4c9b8]">
                ...
                <textarea name="comentario" rows="3" 
                          ...
                          placeholder="Ej: Documento recibido..."></textarea>
                <p class="text-xs text-gray-500 mt-1.5 flex items-center gap-1">
                    <span class="iconify w-3.5 h-3.5 text-gray-400" data-icon="mdi:information-outline"></span>
