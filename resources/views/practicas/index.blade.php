        ...
        <div class="bg-[#f8f8f8] rounded-xl shadow-md border border-gray-200/80 overflow-hidden transition hover:shadow-lg hover:border-green-200">
            <div class="p-4 sm:p-6">
                ...
                <div class="mt-6">
                    ...
                    @php
                        $documentosOrdenados = [
                            'Solicitud de Prácticas Profesionales' => ['ruta' => 'subir-solicitud'],
                            'Elección de Modalidad' => ['ruta' => 'subir-modalidad'],
                            'Carta de Presentación de Prácticas Profesionales' => ['ruta' => 'subir-carta-presentacion'],
                            'Carta de Aceptación' => ['ruta' => 'subir-carta-aceptacion'],
                            'Primer Informe de Actividades' => ['ruta' => 'subir-reporte-parcial'],
                            'Segundo Informe de Actividades' => ['ruta' => 'subir-reporte-final'],
                            'Evaluación de Competencias del Desempeño' => ['ruta' => 'subir-evaluacion'],
                            'Carta de Liberación de Prácticas Profesionales' => ['ruta' => 'subir-liberacion'],
                        ];
                                    ...
                                    <div class="bg-white rounded-lg border border-gray-200/80 hover:border-green-200 transition">
                                        <div class="grid grid-cols-1 md:grid-cols-12 gap-3 items-start md:items-center p-3">
                                            ...
                                            <div class="flex flex-wrap items-center justify-start sm:justify-end gap-1.5 md:col-span-1 w-full md:w-auto">
                                                ...
                                                <!-- ========================================== -->
                                                <!-- BOTÓN DE COMENTARIOS CON HOVER (CORREGIDO) -->
                                                <!-- ========================================== -->
                                                @if($tieneComentarios)
...
<!-- ========================================== -->
<!-- JAVASCRIPT PARA MARCAR COMENTARIOS COMO LEÍDOS (CORREGIDO) -->
<!-- ========================================== -->
<script>
