...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <div class="sm:hidden mb-4">
        <a href="{{ route('practicas.index') }}" class="inline-flex items-center gap-2 text-green-700 hover:text-green-900 transition text-sm font-medium">
            <span class="iconify w-5 h-5" data-icon="mdi:arrow-left-circle"></span>
            Volver al inicio
        </a>
    </div>

    <!-- Título con icono - VERDE OSCURO/ESMERALDA -->
    <div class="flex items-center gap-3 mb-6">
        <span class="iconify w-8 h-8 sm:w-10 sm:h-10 text-emerald-700" data-icon="mdi:file-check-outline"></span>
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Subir Carta de Liberación - Prácticas Profesionales</h1>
    </div>
    ...
    <!-- ========================================== -->
    <form method="POST" action="{{ route('practicas.guardar-liberacion', $practica->id) }}" enctype="multipart/form-data" 
        ...
        <div class="p-4 sm:p-8 space-y-6">
            ...
            <div class="bg-white/70 rounded-lg p-4 border border-[#d4c9b8]">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-700 font-medium">Documento oficial que certifica la finalización de las Prácticas Profesionales del estudiante.</p>
            ...
            <div class="bg-white/80 rounded-lg p-4 border border-[#d4c9b8]">
                <label class="block text-gray-700 font-semibold text-sm mb-2">
                    ...
                    Archivo PDF (Carta de Liberación) <span class="text-red-500">*</span>
                </label>
                <div class="relative">
            ...
            <div class="bg-white/80 rounded-lg p-4 border border-[#d4c9b8]">
                ...
                <textarea name="comentario" rows="3" 
                          ...
                          placeholder="Ej: Trámite completado..."></textarea>
                <p class="text-xs text-gray-500 mt-1.5 flex items-center gap-1">
                    <span class="iconify w-3.5 h-3.5 text-gray-400" data-icon="mdi:information-outline"></span>
            ...
            <div class="pt-4 flex flex-col sm:flex-row gap-3">
                ...
                <a href="{{ route('practicas.index') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#d4c9b8] hover:bg-[#c4b9a8] text-gray-700 text-sm font-medium rounded-lg transition shadow-sm">
                    <span class="iconify w-5 h-5" data-icon="mdi:close"></span>
                    Cancelar
                </a>
            </div>
