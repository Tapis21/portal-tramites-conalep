...
<head>
    ...
    <title>Primer Informe - {{ $tipo_tramite }}</title>
    <style>
        @page {
            size: letter;
...
<body>
    <div class="header">
        ...
        <h1>Primer Informe de Actividades</h1>
    ...
    <div class="content">
        ...
        <h2 style="color:#006837; margin-top:25px;">Actividades realizadas</h2>
        <p>_____________________________________________________________</p>
        <p>_____________________________________________________________</p>
        <p>_____________________________________________________________</p>
        <p>_____________________________________________________________</p>

        <h2 style="color:#006837; margin-top:20px;">Observaciones</h2>
        <p>_____________________________________________________________</p>
        <p>_____________________________________________________________</p>
        <p>_____________________________________________________________</p>
