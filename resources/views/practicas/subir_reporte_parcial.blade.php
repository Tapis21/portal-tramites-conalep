...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <!-- Título con icono - AZUL CLARO/SKY -->
    <div class="flex items-center gap-3 mb-6">
        <span class="iconify w-8 h-8 sm:w-10 sm:h-10 text-sky-600" data-icon="mdi:file-clock"></span>
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Subir Primer Informe de Actividades - Prácticas Profesionales</h1>
    </div>
    ...
    <form method="POST" action="{{ route('practicas.guardar-reporte-parcial', $practica->id) }}" enctype="multipart/form-data" 
        ...
        <div class="p-4 sm:p-8 space-y-6">
            ...
            <div class="bg-white/70 rounded-lg p-4 border border-[#d4c9b8]">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-sm">
                    ...
                    <div>
                        ...
                        <span class="text-blue-600 font-medium block">360 horas (total)</span>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <p class="text-xl font-bold text-gray-800 mt-1">
                        ...
                        @else
                            <span class="text-xs text-amber-600 font-normal ml-2">
                                <span class="iconify w-3.5 h-3.5 inline align-middle mr-0.5" data-icon="mdi:clock-outline"></span>
                                Faltan {{ 180 - $horasCompletadas }} horas
                            </span>
                        @endif
                    </p>
                </div>
                <div class="bg-white/70 rounded-lg p-4 border border-[#d4c9b8]">
                    <div class="flex items-center gap-2">
                        <span class="iconify w-5 h-5 text-sky-600" data-icon="mdi:information-outline"></span>
                        <span class="text-sm text-gray-600 font-medium">Requisito mínimo</span>
                    </div>
                    <p class="text-xl font-bold text-sky-600 mt-1">180 horas</p>
                </div>
            </div>
