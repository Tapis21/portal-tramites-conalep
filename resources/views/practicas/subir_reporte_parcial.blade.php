...
<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
            ...
            <p class="mb-4 text-sm text-gray-600">Primer informe de actividades (180 horas).</p>

            <form method="POST" action="{{ route('practicas.guardar-reporte-parcial', $practica->id) }}" enctype="multipart/form-data">
                @csrf

                <div class="mb-4">
                    <label class="block text-gray-700 mb-2">Archivo PDF (Primer Informe)</label>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="comentario" rows="2" class="w-full p-2 border rounded" placeholder="Ej: Primer informe..."></textarea>
