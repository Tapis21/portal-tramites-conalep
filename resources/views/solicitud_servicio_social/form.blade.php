...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <!-- ========================================== -->
    <form method="POST" action="{{ route('solicitud-servicio-social.store') }}" class="bg-[#f5f0e8] rounded-xl shadow-xl border border-[#d4c9b8] overflow-hidden" style="background: linear-gradient(145deg, #f5f0e8 0%, #faf6ef 100%);">
        @csrf
