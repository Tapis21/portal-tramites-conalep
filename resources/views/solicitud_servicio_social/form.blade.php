...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Solicitud de Servicio Social</h1>
    </div>
    ...
    <!-- FORMULARIO -->
    <!-- ========================================== -->
    <form method="POST" action="{{ route('solicitud-servicio-social.store') }}" class="bg-[#f8f8f8] rounded-xl shadow-md border border-gray-200/80 overflow-hidden">
        @csrf

        <div class="p-4 sm:p-8 space-y-8">
            <!-- ========== 1. DATOS DEL ESTUDIANTE ========== -->
            <div class="border-b border-gray-200/80 pb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="bg-white rounded-lg p-3 border border-gray-200/80">
                    ...
                    <div class="bg-white rounded-lg p-3 border border-gray-200/80 sm:col-span-2 lg:col-span-3">
            ...
            <div class="border-b border-gray-200/80 pb-6">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-green-50/70 rounded-lg p-4 border border-green-200">
                        ...
                        <div class="relative">
                            <select name="horario_id" id="horario_id" 
                                    class="w-full appearance-none bg-white border border-green-300 rounded-lg px-4 py-3 pr-10 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 transition shadow-sm hover:border-green-500 cursor-pointer">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center px-3 pointer-events-none">
                                <span class="iconify w-5 h-5 text-green-500" data-icon="mdi:chevron-down"></span>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="bg-white rounded-lg p-4 border border-gray-200/80">
                            <label class="block text-gray-700 font-semibold text-sm mb-2">
                            ...
                            <div class="relative">
                                <input type="text" name="fecha_inicio" id="fecha_inicio" 
                                       ...
                                       class="flatpickr-input w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 transition shadow-sm hover:border-green-400 cursor-pointer"
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200/80">
                            ...
                            <input type="text" id="fecha_finalizacion" name="fecha_finalizacion"
                                   class="w-full bg-gray-100 border border-gray-300 rounded-lg px-4 py-3 text-gray-600 text-sm cursor-not-allowed"
                                   readonly placeholder="Selecciona fecha de inicio">
                            <p class="text-xs text-gray-500 mt-1.5 flex items-center gap-1">
                                <span class="iconify w-3.5 h-3.5 text-gray-400" data-icon="mdi:information-outline"></span>
                                Se suman 6 meses exactos
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="bg-green-50/70 rounded-lg p-4 border border-green-200">
                        ...
                        <div class="relative">
                            <select name="empresa_id" 
                                    class="w-full appearance-none bg-white border border-green-300 rounded-lg px-4 py-3 pr-10 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 transition shadow-sm hover:border-green-500 cursor-pointer" required>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="bg-white rounded-lg p-4 border border-gray-200/80">
                            ...
                            <div class="relative">
                                <select name="grado_academico_id" 
                                        class="w-full appearance-none bg-white border border-green-300 rounded-lg px-4 py-3 pr-10 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 transition shadow-sm hover:border-green-500 cursor-pointer" required>
                        ...
                        <div class="bg-white rounded-lg p-4 border border-gray-200/80">
                            ...
                            <input type="text" name="nombre_persona_carta" value="{{ old('nombre_persona_carta') }}" 
                                   class="w-full bg-white border border-gray-300 rounded-lg px-4 py-3 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 transition shadow-sm hover:border-green-400" 
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div class="bg-white rounded-lg p-4 border border-gray-200/80">
                            ...
                            <div class="relative">
                                <select name="grado_academico_jefe_id" 
                                        class="w-full appearance-none bg-white border border-green-300 rounded-lg px-4 py-3 pr-10 text-gray-700 text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-600 transition shadow-sm hover:border-green-500 cursor-pointer" required>
                                    <option value="" disabled selected class="text-gray-400">— SELECCIONA UN GRADO —</option>
                                    @foreach($grados as $grado)
            ...
            <div class="pt-4 flex flex-col sm:flex-row gap-3">
                ...
                <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 text-sm font-medium rounded-lg transition shadow-sm border border-gray-200/80">
                    <span class="iconify w-5 h-5" data-icon="mdi:close"></span>
                    Cancelar
                </a>
            </div>
