                    ...
                    @php
                        $documentosOrdenados = [
                            'Solicitud de Servicio Social' => [
                                ...
                                'ruta_pdf' => 'servicio-social.descargar-solicitud-pdf'
                            ],
                            'Elección de Modalidad' => [
                                ...
                                'ruta_pdf' => 'servicio-social.descargar-modalidad-pdf'
                            ],
                            'Carta de Presentación de Servicio Social' => [
                                ...
                                'ruta_pdf' => 'servicio-social.descargar-carta-presentacion-pdf'
                            ],
                            'Carta de Aceptación' => [
                                'tipo' => 'admin',
                            ...
                            'Primer Informe de Actividades Trimestral' => [
                                ...
                                'ruta_pdf' => 'servicio-social.descargar-primer-informe-pdf',
                            ...
                            'Segundo Informe de Actividades Trimestral' => [
                                ...
                                'ruta_pdf' => 'servicio-social.descargar-segundo-informe-pdf',
                            ...
                            'Evaluación de Competencias del Desempeño' => [
                                ...
                                'ruta_pdf' => 'servicio-social.descargar-evaluacion-pdf'
                            ],
                        ...
                        <div class="space-y-2">
                            @foreach($documentosOrdenados as $nombre => $config)
                                @php
                                    ...
                                    if ($descargable && $servicioSocial->fecha_inicio) {
                                        // Si es un informe, verificar los 5 días antes de la fecha límite
                                        if ($config['tipo'] === 'informe' && $fechaLimite) {
                                            $hoy = now();
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-12 gap-2 items-center p-3">
                                        ...
                                        <div class="md:col-span-2 flex flex-wrap items-center justify-center gap-1">
                                            @if($mostrarBotonPDF && $rutaPdf)
                                                <a href="{{ route($rutaPdf, $servicioSocial->id) }}" 
