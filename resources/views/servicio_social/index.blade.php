...
<div class="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900">Mi Servicio Social</h1>
    </div>
            ...
            <div class="p-4 sm:p-6">
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
                    <div class="bg-white rounded-lg p-2 sm:p-3 border border-gray-200/80 hover:border-green-200 transition">
                        ...
                        <p class="text-sm sm:text-base font-semibold text-gray-900">{{ $servicioSocial->fecha_inicio ? \Carbon\Carbon::parse($servicioSocial->fecha_inicio)->format('d/m/Y') : 'No definida' }}</p>
                    </div>
                    <div class="bg-white rounded-lg p-2 sm:p-3 border border-gray-200/80 hover:border-green-200 transition">
                        <p class="text-xs text-gray-500 flex items-center gap-1">
                        ...
                        <p class="text-sm sm:text-base font-semibold text-gray-900">{{ $servicioSocial->fecha_limite_primer_informe ? \Carbon\Carbon::parse($servicioSocial->fecha_limite_primer_informe)->format('d/m/Y') : 'No definida' }}</p>
                    </div>
                    <div class="bg-white rounded-lg p-2 sm:p-3 border border-gray-200/80 hover:border-green-200 transition">
                        <p class="text-xs text-gray-500 flex items-center gap-1">
                        ...
                        <p class="text-sm sm:text-base font-semibold text-gray-900">{{ $servicioSocial->fecha_limite_segundo_informe ? \Carbon\Carbon::parse($servicioSocial->fecha_limite_segundo_informe)->format('d/m/Y') : 'No definida' }}</p>
                    </div>
                    <div class="bg-white rounded-lg p-2 sm:p-3 border border-gray-200/80 hover:border-green-200 transition">
                        <p class="text-xs text-gray-500 flex items-center gap-1">
                ...
                <div class="mt-6">
                    ...
                    @php
                        $documentosOrdenados = [
                            ...
                            'Primer Informe de Actividades Trimestral' => ['tipo' => 'informe', 'ruta' => 'subir-reporte-parcial', 'campo' => null],
                            'Segundo Informe de Actividades Trimestral' => ['tipo' => 'informe', 'ruta' => 'subir-reporte-final', 'campo' => null],
                        ...
                        // ✅ BUSCAR TODOS LOS DOCUMENTOS EN tabla documentos
                            ...
                            <div class="space-y-2">
                                @foreach($documentosOrdenados as $nombre => $config)
                                    @php
                                        ...
                                        // ✅ BLOQUEO PARA validado Y validado_ventanilla
                                        $documentoBloqueado = $doc && in_array($doc->estatus, ['validado', 'validado_ventanilla']);
                                        
                                        // Comentarios
                                        $comentariosTooltip = $doc ? $doc->comentarios()->orderBy('created_at', 'desc')->get() : collect();
