...
<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
            <h2 class="text-2xl font-bold mb-5">Subir Elección de Modalidad</h2>
            ...
            <p class="mb-4 text-sm text-gray-600">Este documento incluye la autorización del tutor para que el alumno pueda realizar su Servicio Social.</p>
