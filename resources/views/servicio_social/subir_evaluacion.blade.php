...
<div class="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-gray-800">Subir Evaluación de Competencias del Desempeño</h1>
    </div>
        ...
        <div class="p-4 sm:p-8 space-y-6">
            ...
            <div class="bg-white/70 rounded-lg p-4 border border-[#d4c9b8]">
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        <p class="text-sm text-gray-700 font-medium">Documento donde se evalúa el desempeño del estudiante durante su Servicio Social.</p>
