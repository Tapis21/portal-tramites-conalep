...
<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl rounded-lg p-6">
            <h2 class="text-2xl font-bold mb-5">Subir Carta de Presentación</h2>
            ...
            <p class="mb-4 text-sm text-gray-600">Documento oficial que presenta al estudiante ante la empresa donde realizará su Servicio Social.</p>
